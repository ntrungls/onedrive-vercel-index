...
module.exports = {
  ...
  obfuscatedClientSecret: 'U2FsdGVkX1/OKbc+mJgmV6g8Njo8Qmg0mloR3SnIq4DkL3bFQkHsLHJL1X2Cnaw9ABdJ9Hg6uRybLLhKMP79VQ==',
  ...
  driveApi: 'https://graph.microsoft.com/v1.0/sites/ntrungg.sharepoint.com,222cc9ff-1fdf-4b89-b1ea-7a30f4ed777b,998fc76a-6498-4956-b7d4-797909784468/drive',

  // The scope we require are listed here, in most cases you would not need to change this as well.
  scope: 'user.read file.read.all sites.read.all offline_access',
  ...
  cacheControlHeader: 'max-age=0, s-maxage=86400, stale-while-revalidate',
}
